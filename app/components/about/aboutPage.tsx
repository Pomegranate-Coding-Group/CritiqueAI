...
export function AboutPage() {
    return <Section size="3">
        ...
        <Container size="3" css={{ ta: "center", mb: "$6", fontFamily: '$rowdies', letterSpacing: '1px', color: 'white', fontSize: '$6', display: "flex", flexDirection: "column" }}>
        <Heading size="3" css={{ ta: "center", mb: "$3", mt: "$6", fontFamily: '$rowdies', letterSpacing: '1px', color: 'white' }}>
                Pomegranate Coding Team
            </Heading>
            <Flex direction={"row"} css={{ ta: "center", alignItems: "center", flexWrap:"nowrap"}}>
                {/* <section> */}
                    <div >
                        <div style={{ borderRadius: '50%', overflow: 'hidden', width: "250px", height: "250px", margin: "25px" }}>
                            <Image src={jasonPic}  ></Image>
                        </div>
                        <p>Jason Pyke (Dev) </p>
                    </div>
                    <div>
                        <div style={{ borderRadius: '50%', overflow: 'hidden', width: "250px", height: "250px", margin: "25px" }}>
                            <Image src={colinPic}></Image>
                        </div>
                        <p>   Colin Kwiecinski (Dev) </p>
                    </div>
                    <div>
                        <div style={{ borderRadius: '50%', overflow: 'hidden', width: "250px", height: "250px", margin: "25px" }}>
                            <Image src={anniePic}></Image>
                        </div>
                        <p >Annie Bequette (PM)</p>
                    </div>
                    <div>
                        <div style={{ borderRadius: '50%', overflow: 'hidden', width: "250px", height: "250px", margin: "25px" }}>
                            <Image src={dcPic}></Image>
                        </div>
                        <p>Alex Dumitru Carcoana (Design &amp; Dev)</p>
                    </div>
                {/* </section> */}
